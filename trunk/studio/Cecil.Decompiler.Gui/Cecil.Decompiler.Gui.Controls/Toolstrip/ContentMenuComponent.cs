...
{
    internal class ContentMenuComponent : ContextMenuStrip, IBar
    {
        private readonly Dictionary<string, ToolStripItem> actionitems = new Dictionary<string, ToolStripItem>();
        IBarItemCollection items;

        public ContentMenuComponent()
        {
            WireCollection(base.Items);
        }

        internal void WireItems()
        {
            WireItems(base.Items);
        }

        public new IBarItemCollection Items
        {
            get
            {
                return items;
        ...
        internal void WireItems(ToolStripItemCollection collection)
        {
            ...
            {
                OnItemAdded(new ToolStripItemEventArgs(item));
            }
        }
        ...
        protected override void OnItemAdded(ToolStripItemEventArgs e)
        {
            ...
            if (e.Item is ToolStripMenuItem)
            {
                ...
                {
                    OnItemAdded(new ToolStripItemEventArgs(subitem));
                }
            }
        }
